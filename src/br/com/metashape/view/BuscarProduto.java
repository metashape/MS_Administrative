...
public class BuscarProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ver tudo", "Nome ", "Código SKU", "Categoria", " " }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome ", "Código", "Categoria", "Sabor", "Quantidade", "Valor"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Object[] linha = {procurado.getNome_sku(), procurado.getCod_sku(), procurado.getDescricao(), procurado.getSabor_cor(), procurado.getQuantidade(), procurado.getValor()};
            model.addRow(linha);
